...
---@field on_ready? fun(item_widget?: wibox.widget, item: MeboxItem, menu: Mebox, args?: Mebox.show.args, context?: Mebox.context)
---@field layout_id? string
---@field layout_add? fun(layout: wibox.layout, item_widget: wibox.widget)
