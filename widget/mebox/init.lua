...
---@field submenu? (fun(menu: Mebox): Mebox_new_args)|Mebox_new_args
---@field callback? fun(item: MeboxItem, menu: Mebox, context?: Mebox_context)
---@field on_show? fun(item: MeboxItem, menu: Mebox, args?: Mebox_show_args, context?: Mebox_context): boolean?
---@field on_hide? fun(item: MeboxItem, menu: Mebox)
---@field on_ready? fun(item_widget?: wibox.widget, item: MeboxItem, menu: Mebox, args?: Mebox_show_args, context?: Mebox_context)
---@field layout_id? string
---@field layout_add? fun(layout: wibox.widget, item_widget: wibox.widget)
...
---@class Mebox_show_args
---@field selected_index? integer
---@field coords? point
---@field screen? screen
---@field placement? placement

---@class Mebox_new_args
---@field orientation? orientation
---@field layout_template? widget_value
---@field layout_navigator? fun(menu: Mebox, x: sign, y: sign, direction?: direction, context?: Mebox_context)
---@field cache_submenus? boolean
---@field items_source (fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context): MeboxItem[])|MeboxItem[]
---@field on_show? fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context): boolean?
---@field on_hide? fun(menu: Mebox)
---@field on_ready? fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context)
---@field mouse_move_select? boolean
---@field mouse_move_show_submenu? boolean
...
---@class Mebox : wibox
---@operator call: Mebox
---@field package _private Mebox_private
local mebox = { mt = {} }
...
---@field item_widgets? (wibox.widget|false)[]
---@field selected_index? integer
---@field orientation orientation
---@field layout? wibox.widget
---@field layout_template widget_value
---@field layout_container wibox.widget
---@field layout_navigator? fun(menu: Mebox, x: sign, y: sign, direction?: direction, context?: Mebox_context)
---@field items_source MeboxItem[]|fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context)
---@field on_show? fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context): boolean
---@field on_hide? fun(menu: Mebox)
---@field on_ready? fun(menu: Mebox, args?: Mebox_show_args, context?: Mebox_context)
---@field mouse_move_select boolean
...
function mebox:get_item_widget(index)
    -- Leave it as it is!
...
function mebox:show_submenu(index, context)
    ...
    if not submenu then
        local submenu_args = type(item.submenu) == "function"
            and item.submenu(self) --[[@as Mebox_new_args]]
            or item.submenu
...
---@param direction? integer|"begin"|"end"
