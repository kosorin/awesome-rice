...
---@field button table<string, BindingButton>
---@field modifier table<string, BindingModifier>
...
do
    ---@type { length: integer, [BindingModifier]: integer }
    local modifier_hash_data = { length = 0 }

    ---@param modifiers BindingModifier[]
...
---@field on_release? fun(trigger: BindingTrigger, ...)
---@field modifiers? BindingModifier[]
---@field triggers BindingTrigger.args
...
---@param modifiers? BindingModifier[]
---@param triggers BindingTrigger.args
