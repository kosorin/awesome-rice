...
### Auto Installer
You may use our autoinstall script, which is only supported on Arch Linux for now (Assuming you have Xorg and Yay installed, this does not configure your .xinitrc) 
```sh
